...
<div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-3">
    ...
    <div>
        ...
        <input type="text" class="w-full border rounded px-3 py-2" wire:model.defer="form.barcode">
        @error('form.barcode')
            <div class="text-red-600 text-xs mt-1">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="md:col-span-2">
        ...
        <input type="text" class="w-full border rounded px-3 py-2" wire:model.defer="form.name">
        @error('form.name')
            <div class="text-red-600 text-xs mt-1">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div>
        ...
        <input type="number" step="0.01" class="w-full border rounded px-3 py-2" wire:model.defer="form.karat">
        @error('form.karat')
            <div class="text-red-600 text-xs mt-1">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div>
        ...
        @error('form.sell_price_per_gram')
            <div class="text-red-600 text-xs mt-1">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div>
        ...
        <input type="number" step="0.01" class="w-full border rounded px-3 py-2" wire:model.defer="form.making_fee">
        @error('form.making_fee')
            <div class="text-red-600 text-xs mt-1">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="md:col-span-2">
        ...
        <textarea class="w-full border rounded px-3 py-2" rows="3" wire:model.defer="form.notes"></textarea>
        @error('form.notes')
            <div class="text-red-600 text-xs mt-1">{{ $message }}</div>
        @enderror
    </div>
